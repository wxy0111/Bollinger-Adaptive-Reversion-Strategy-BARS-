...
# Bollinger trend-expansion guard.
# BTG趋势扩张守卫：观察模式只记录/通知；控制模式才会平仓。
BOLL_TREND_GUARD_OBSERVE_ENABLED = True
BOLL_TREND_GUARD_CONTROL_ENABLED = False
BOLL_TREND_GUARD_ENABLED = BOLL_TREND_GUARD_CONTROL_ENABLED
BOLL_TREND_GUARD_HEAD_ADVERSE_PCT = 0.03
BOLL_TREND_GUARD_WIDTH_EXPAND = 2.5
BOLL_TREND_GUARD_WIDTH_PCT = 0.035
BOLL_TREND_GUARD_SLOPE_WINDOW_MIN = 45
BOLL_TREND_GUARD_MIN_HOLD_MIN = 30
BOLL_TREND_GUARD_Z_MEAN = 1.0
BOLL_TREND_GUARD_SLOPE_PCT_PER_HOUR = 1.2
BOLL_TREND_GUARD_NOTIFY_INTERVAL_SEC = 3600
BOLL_TREND_GUARD_STOP_AFTER_CLOSE = True
